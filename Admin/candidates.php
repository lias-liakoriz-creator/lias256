          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered">
                ...
                <tbody>
                  <?php
                    $sql = "SELECT *, candidates.candidate_id AS canid FROM candidates LEFT JOIN positions ON positions.position_id=candidates.position_id ORDER BY positions.priority ASC";
...
function getRow(id){
  $.ajax({
    ...
    success: function(response){
      ...
      $('#posselect').val(response.position_id).html(response.position_name);      
